...
- [ ] Radio (Maybe)
- [x] Password Vault, Store all your passwords in encrypted file! (if you want to reset the vault, you must delete the file inside "AdvanceOS/Vault" folder , it will delete the stored password's as well. so reamember your main vault password!!)
...
- [x] Screenshot press ButtonGO (top right button) to take screenshot (will be save in AdvanceOS folder)
