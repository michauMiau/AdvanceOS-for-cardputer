...
- [X] IR Editor you can rename command name and edit the actual signal by connecting IR reciver to pin 1 (or use m5stack IR REMOTE chip) use names like UP, DOWN , UP, RIGHT,POWER, OK ,VOL+ VOL, -MUTE to makeit appears as special key in the sender ( like arrows etc...) the special keys bind yo keys in the cardputer like the cardputer arrows
